...
async def process_ba_template(project_id, requirements_text):
    ...
    try:
        ...
        pdf_filename = f"ba_requirements_{project_id}_{timestamp}.pdf"
        ...
        if items:
            ...
            # Create new document
            doc_id = f"ba_requirements_{project_id}_{timestamp}"
            requirements_data = {
                "id": doc_id,
                "template_type": "ba",
                "content": content,
...
def generate_pdf(data, output_path):
    ...
    content.append(Paragraph("Business Analyst Requirements Specification", title_style))
    ...
    def add_page_number(canvas, doc):
        ...
        canvas.drawString(doc.leftMargin, 25, "Business Analyst Requirements Specification")
        canvas.restoreState()
