...
async def process_sde_template(project_id, requirements_text):
    ...
    try:
        ...
        pdf_filename = f"sde_requirements_{project_id}_{timestamp}.pdf"
        ...
        if items:
            ...
            # Create new document
            doc_id = f"sde_requirements_{project_id}_{timestamp}"
            requirements_data = {
                "id": doc_id,
                "template_type": "sde",
                "content": content,
...
def generate_pdf(data, output_path):
    ...
    content.append(Paragraph("SDE Requirements Specification", title_style))
    ...
    def add_page_number(canvas, doc):
        ...
        canvas.drawString(doc.leftMargin, 25, "SDE Requirements Specification")
        canvas.restoreState()
