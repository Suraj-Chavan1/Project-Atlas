...
def generate_view_url(blob_name, file_type):
...
def download_blob(blob_name, local_path=None):
    ...
    try:
        ...
        print(f"Downloaded {blob_name} to {local_path} successfully")
        return True
    except Exception as e:
...
upload_file("D:\Braclays\dummy.docx")
print("\n=== USAGE EXAMPLES ===")
print("# Upload a file")
print("upload_file('C:/path/to/your/file.pdf')")
print("\n# Download a file")
print("download_blob('filename.pdf', 'C:/path/to/save/downloaded_file.pdf')")
print("\n# Delete a file")
print("delete_blob('filename.pdf')")
print("=" * 50)

# Uncomment these examples to use the functions
# result, url = upload_file("C:/path/to/your/file.pdf")
# download_blob("sample.pdf", "C:/Downloads/sample.pdf")
# delete_blob("file_to_delete.pdf")