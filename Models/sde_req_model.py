...
async def main():
    """Main function to process SDE template using document input."""
    try:
        ...
        # Generate SDE requirements
        print(f"\nGenerating SDE requirements for project: {project_name}")
        doc_id, requirements_data = await process_sde_template(project_id, requirements_text)
        
        # Generate PDF
        print("\nGenerating PDF document...")
        pdf_path = f"SDE_Requirements_{project_id}.pdf"
        generate_pdf(requirements_data["content"], pdf_path)
        
        # Upload to Blob Storage
        print("\nUploading PDF to Blob Storage...")
        blob_name = f"sde_requirements/{project_id}/{pdf_path}"
